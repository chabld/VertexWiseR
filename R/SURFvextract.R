...
#' @param subj_ID A logical object stating whether to include subject IDs (T) in the object or not (F). Default is TRUE.
#'
#' @returns A .rds file containing a matrix object. The matrix can be used independently by VertexWiseR to compute statistical analyses. Each row corresponds to a subject's left and right hemisphere vertex-wise cortical thickness values
#' @examples
